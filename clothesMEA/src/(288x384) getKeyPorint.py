...
reSizeImage, _ = utils.resizeWithPad(img, (288, 384))
...
# 히트맵 사이즈 보정
scaling_factor_x = reSizeImage.shape[0] / con.HEATMAP_SIZE[0]
scaling_factor_y = reSizeImage.shape[1] / con.HEATMAP_SIZE[1]
...
plt.imshow(cv2.cvtColor(reSizeImage, cv2.COLOR_BGR2RGB))
plt.show()
